...
public class UIAniSprite_Alpha : MonoBehaviour {
    ...
    public void PlayAnimation ()
    {
        ...
        twn = HOTween.To( this , animationTime , new TweenParms().Prop("currentAlpha", endALpha , false ).Ease ( EaseType.EaseInExpo ).OnUpdate ( ChangeAlpha ) );
    }
